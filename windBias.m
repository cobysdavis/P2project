...
directionBias(5) = (directionBias(1)^2 + directionBias(3)^2)^0.5; %NW
directionBias(6) = (directionBias(1)^2 + directionBias(4)^2)^0.5; %NE
directionBias(7) = (directionBias(2)^2 + directionBias(3)^2)^0.5; %SW
directionBias(8) = (directionBias(2)^2 + directionBias(4)^2)^0.5; %SE
